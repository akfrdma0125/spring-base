...
class CalculationRequestTest {
    @Test
    void test_for_parsing_valid_number() {
        //given
    ...
    @Test
    void test_for_parsing_valid_number_over_digits() {
        //given
    ...
    @Test
    void test_for_parsing_invalid_parts_length() {
        //given
    ...
    @Test
    void test_for_parsing_invalid_operator() {
        //given
    ...
    @Test
    void test_for_parsing_invalid_operator_length() {
        //given
        String[] parts = new String[]{"1000", "+-", "1234"};
